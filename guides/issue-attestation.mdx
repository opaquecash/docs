...
description: End-to-end issuer flow — attest to a stealth identity and announce for discovery.
---
...
for (const a of attestations) {
  console.log(a.uid, a.schemaId, a.stealthAddressHash, a.fieldValues);
}
```
