...
description: Stealth payments, provable reputation, and cross-chain announcements — one TypeScript SDK.
---
...
Most apps only need **`@opaquecash/opaque`**. Lower-level packages (`stealth-chain`, `psr-core`, `uab`, etc.) are re-exported when you need a narrow surface. See [Installation](/sdk/installation).
