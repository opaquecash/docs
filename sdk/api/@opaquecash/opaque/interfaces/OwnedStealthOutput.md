...
Defined in: [packages/opaque/src/types/indexer.ts:24](https://github.com/opaquecash/sdk/blob/1ac32abb86be54d81add3fae49381204ea1eb7c5/packages/opaque/src/types/indexer.ts#L24)

One output the recipient owns (from WASM `scan_attestations` + normalized context).

## Extended by

- [`UnifiedOwnedOutput`](UnifiedOwnedOutput.md)
