...
[buildVerifyReputationInstruction](/sdk/api/@opaquecash/opaque/namespaces/solanaPsr/functions/buildVerifyReputationInstruction.md) only for non-standard builds.
